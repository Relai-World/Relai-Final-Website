...
//       const validBudgets = properties.filter(p => p.minimumBudget && typeof p.minimumBudget === 'number');
...
//       const validLocations = properties.map(p => safeToString(p.location)).filter(loc => loc && loc !== 'N/A');
...
//         }
//         doc.setFont('helvetica', 'bold');
//         doc.text(`${index + 1}. ${safeToString(property.projectName || property.name)}`, margin, yPosition);
//         yPosition += 6;
//         doc.setFont('helvetica', 'normal');
...
//           doc.setFontSize(12);
//           doc.setFont('helvetica', 'bold');
//           doc.text(`${currentPropertyIndex + 1}. ${safeToString(property.projectName || property.name)}`, margin + 5, yPosition + 8);
//           yPosition += 18;
...
//             ['Developer:', safeToString(property.developerName || property.builder)],
...
//             ['Possession:', safeToString(property.possessionDate || property.possession)]
//           ];
