import { Check, MessageSquare, Phone, HomeIcon, Building2, Handshake, Search, Route, ClipboardCheck, Shield, FileText, Banknote, FileSignature, UserCheck2, CircleCheck, Home, PiggyBank, BadgeCheck, ArrowRight, Heart, Star, Sparkles, Lightbulb, Compass, Users, Calendar, Clock } from "lucide-react";
...
import { WhatsAppIcon } from "./RelaiExperienceFixed";
...
export default function RelaiExperience() {
  ...
  const [showExpertSessionForm, setShowExpertSessionForm] = useState(false);
  ...
  const handleSubmit = () => {
    if (validateForm()) {
      setShowExpertSessionForm(false);
  ...
  return (
    <section className="py-12 md:py-20">
            ...
            <div className="relative z-20 flex flex-col items-center">
              ...
              >
                ...
                >
                  ...
                  <motion.span 
                    className="inline-block bg-white text-[#1752FF] px-4 py-3 rounded-lg mx-2 ml-3 leading-relaxed"
                    animate={{ 
                      y: [0, -5, 0],
                      boxShadow: [
            ...
            <Card className="shadow-lg h-full border-t-4 border-t-[#1752FF] hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {/* Book Expert Session Button - Show Contact Form */}
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button 
                      className="w-full bg-[#1752FF] hover:bg-[#103cc9] text-white group"
                      onClick={() => setShowExpertSessionForm(true)}
                    >
                  ...
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button 
                      className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white group"
          ...
          >
            <Card className="shadow-lg h-full border-t-4 border-t-[#1752FF] hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-6 text-center">
                  Buy with confidence at relai—we offer a Guaranteed Resale within 30 days if you wish to sell residential and commercial property in Hyderabad.Our expert network ensures quick, credible buyers and positions us as your selling commercial property Hyderabad expert.
                </p>
                
                <div className="space-y-3 mb-6">
                  {/* Book Expert Session Button - Connected to Property Wizard */}
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button 
                      className="w-full bg-[#1752FF] hover:bg-[#103cc9] text-white group"
                      onClick={() => setShowExpertSessionForm(true)}
      ...
      {/* Expert Session Form Dialog */}
      <Dialog open={showExpertSessionForm} onOpenChange={setShowExpertSessionForm}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200 mb-6">
            <p className="text-center text-green-800 font-medium">
              Get personalized property guidance from certified experts
            </p>
            <p className="text-center text-green-600 text-sm mt-1">
              Our experts will help you navigate the property market and find your ideal investment.
            </p>
          </div>

          <div className="space-y-4">
            <div>
              <Label htmlFor="session-name" className="flex items-center text-gray-700 mb-2">
            ...
            <div>
              <Label htmlFor="session-phone" className="flex items-center text-gray-700 mb-2">
              ...
              <p className="text-xs text-gray-500 mt-1">
                We'll send session details to this WhatsApp number
              </p>
            </div>

            <div>
              <Label htmlFor="session-email" className="flex items-center text-gray-700 mb-2">
              ...
              <p className="text-xs text-gray-500 mt-1">
                We'll send session confirmation to this email
              </p>
            </div>

            <div>
              <Label htmlFor="session-date" className="flex items-center text-gray-700 mb-2">
            ...
            <div>
              <Label htmlFor="session-time" className="flex items-center text-gray-700 mb-2">
            ...
            <div className="flex gap-3 pt-4">
              <Button
                onClick={() => setShowExpertSessionForm(false)}
                variant="outline"
                className="flex-1"
              >
                Cancel
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="text-center py-6">
            ...
            <p className="text-gray-700 mb-2">
              Thank you for booking an expert session with us!
            </p>
            <p className="text-sm text-gray-600">
              Our property expert will contact you within 24 hours to confirm your session details.
            </p>
          </div>
